...
class Line < GeometryValue
  ...
  def intersectLine line
    if real_close(@m,line.m)
      ...
      newx = (line.b - @b) / (@m - line.m)
      newy = @m * x + @b
      Point.new(newx,newy)
    end
  end

  def intersectVerticalLine vlinr
...
class LineSegment < GeometryValue
  ...
  def intersect op
    op.intersectLineSegment self
  end

  def IntersectPoint p
    p.interesectLineSegment(self)
  end
  ...
  def InteresectVerticalLine vline
